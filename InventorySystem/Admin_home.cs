...
namespace InventorySystemCsharp
{
    public partial class Admin_home : Form
    {
        ...
        private void MpassTxt_OnValueChanged(object sender, EventArgs e)
        {
        ...
        private void MlnameTxt_OnValueChanged(object sender, EventArgs e)
        {

        }

        private void MusernameTxt_OnValueChanged(object sender, EventArgs e)
        {

        }

        private void MphonenumTxt_OnValueChanged(object sender, EventArgs e)
        {
